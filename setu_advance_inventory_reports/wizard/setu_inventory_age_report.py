...
class SetuInventoryAgeReport(models.TransientModel):
    ...
    def download_report(self):
        ...
        return {
            ...
            'url': '/web/binary/download_document?model=setu.inventory.age.report&field=stock_file_data&id=%s&filename=%s' % (
                self.id, file_name),
            'target': 'self',
        }
...
class SetuInventoryAgeBIReport(models.TransientModel):
    ...
    ageing_days = fields.Integer("Ageing Criteria", default=0)
