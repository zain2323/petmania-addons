...
class SetuInventoryFSNXYZAnalysisReport(models.TransientModel):
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 5, 'Average Stock', odd_normal_right_format)
        worksheet.write(row, 6, 'Sales', even_normal_right_format)
        worksheet.write(row, 7, 'Turnover Ratio', odd_normal_right_format)
        ...
        worksheet.write(row, 11, 'XYZ Classification', odd_normal_right_format)
        worksheet.write(row, 12, 'FSN-XYZ Classification', even_normal_right_format)
    ...
    def write_data_to_worksheet(self, workbook, worksheet, data, row):
        ...
        worksheet.write(row, 5, data.get('average_stock',''), odd_normal_right_format)
        worksheet.write(row, 6, data.get('sales',''), even_normal_right_format)
        worksheet.write(row, 7, data.get('turnover_ratio',''), odd_normal_right_format)
        ...
        worksheet.write(row, 10, data.get('fsn_classification',''), even_normal_center_format)
        worksheet.write(row, 11, data.get('xyz_classification',''), odd_normal_center_format)
        worksheet.write(row, 12, data.get('combine_classification',''), even_normal_center_format)
        return worksheet
