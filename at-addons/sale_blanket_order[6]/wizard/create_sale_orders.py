        ...
        lines = [
            (
                ...
                0,
                {
                    ...
                    "remaining_qty_reason": bol.remaining_qty_reason,
    ...
    def create_sale_order(self):
        ...
        for customer in order_lines_by_customer:
            order_vals = {
                ...
                'warehouse_id': line.blanket_line_id.order_id.warehouse.id
            }
...
class BlanketOrderWizardLine(models.TransientModel):
    ...
    @api.onchange('remaining_qty_reason')
    def _onchange_qty_reason(self):
        self.blanket_line_id.remaining_qty_reason = self.remaining_qty_reason
