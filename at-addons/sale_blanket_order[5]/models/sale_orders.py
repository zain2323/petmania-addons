...
#         for rec in self:
#            rec.customer_tags = [(6,0, rec.partner_id.category_id.ids)]  
    
    
# class InvoiceReport(models.Model):
#     _inherit = 'account.invoice.report'
    
#     customer_tags = fields.One2many(comodel_name='res.partner.category', inverse_name="account_report_id", compute="_compute_customer_tags", store=True)
...
class AccountMove(models.Model):
    ...
    customer_tags = fields.Many2many('res.partner.category', compute="_compute_customer_tags", store=True)
