...
class WooInstanceEpt(models.Model):
    ...
    woo_ship_order_webhook = fields.Boolean("Want to ship order while importing order", default=True,
    ...
    woo_refund_order_webhook = fields.Boolean("Want to create a refund while importing order", default=True,
