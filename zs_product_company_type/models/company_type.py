...
class ProductTemplate(models.Model):
    ...
    company_type = fields.Many2one(
        "product.company.type", string="Franchise Division"
    )

class ResPartnerInherit(models.Model):
    _inherit = "res.partner"
    
    custom_company_type = fields.Many2one('product.company.type', string='Franchise Division')
...
class SaleOrderInherit(models.Model):
    ...
    company_type = fields.Many2one(related='product_id.company_type',
                               string='Franchise Division', store=True, readonly=True)
...
class SaleReportInherit(models.Model):
    ...
    company_type = fields.Many2one('product.company.type', string='Franchise Division')
