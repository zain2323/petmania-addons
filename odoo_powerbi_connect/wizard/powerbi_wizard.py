...
class PowerbiWizard(models.TransientModel):
    ...
    def fetch_powerbi_report(self):
        ...
        return {'name': "powerbi.report.view",
                'view_mode': 'form',
                'view_id': False,
    ...
    def fetch_powerbi_dashboard(self):
        ...
        partial = self.env["powerbi.dashboard.wizard"].create({'powerbi_id': dashboardObj.powerbi_id, 'name': dashboardObj.name})
        return {'name': "powerbi.dashboard.view",
                'view_mode': 'form',
                'view_id': False,
